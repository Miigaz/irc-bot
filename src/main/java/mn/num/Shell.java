...
public class Shell extends Thread {
    ...
    public void mkdir(String dir) {
        ...
        if (f.exists()) {
            IRC.sendMessage(Config.getChannel(), "Directory '" + dir + "' already exists!" + " " + f.getPath());
        } else {
            if (f.mkdir()) {
                IRC.sendMessage(Config.getChannel(), "Directory '" + dir + "' created." + " " + f.getPath());
            } else {
                IRC.sendMessage(Config.getChannel(), "Could not create directory '" + dir + "'" + " " + f.getPath());
            }
        }
    }
